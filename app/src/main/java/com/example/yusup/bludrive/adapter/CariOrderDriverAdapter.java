...
import com.example.yusup.bludrive.activity.MapsActivity;
...
public class CariOrderDriverAdapter extends RecyclerView.Adapter<CariOrderDriverAdapter.ViewHolder>{

    private List<GetCariOrderDriver.Datum> listCari;
    private Context context;
    int lastPosition = -1;

    public CariOrderDriverAdapter(List<GetCariOrderDriver.Datum> listCari, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final GetCariOrderDriver.Datum model = listCari.get(position);
