...
import com.example.yusup.bludrive.Fragment.ListOrderFragment;
import com.example.yusup.bludrive.Fragment.ListPesananFragment;
...
public class MainDrawerBos extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_bos_drawer);
        ...
        fragmentManager.beginTransaction()
                .replace(R.id.content_frame, new ListPesananFragment()).commit();
...
//            editor3.commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_pesanan) {
            fragment = new ListPesananFragment();
        } else if (id == R.id.nav_berhasil) {
            fragment = new ListOrderFragment();
        } else if (id == R.id.nav_profile) {
            Intent intent = new Intent(MainDrawerBos.this,EditProfil.class);
            startActivity(intent);
        } else if (id == R.id.nav_password) {
            Intent intent = new Intent(MainDrawerBos.this, ChangePassword.class);
            startActivity(intent);
        } else if (id == R.id.nav_contactus) {
            Intent intent = new Intent(MainDrawerBos.this, ContactActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_about) {
            Intent intent = new Intent(MainDrawerBos.this, AboutActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_logout) {
            prefHandler.setLogout();

            Intent i=new Intent(MainDrawerBos.this,splash_screen.class);
